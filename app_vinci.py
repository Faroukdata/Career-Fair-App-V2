...
# ================== SETTINGS ==================
APP_TITLE  = "Vinci Career Fair"
PAGE_ICON  = "🎓"

# Read (fast): public shared CSV URL (dl=0 or dl=1, force dl=1)
STATE_SHARED_CSV_URL = st.secrets.get("STATE_SHARED_CSV_URL_VINCI")

# Write (API): path inside your Dropbox App Folder
STATE_DBX_PATH = st.secrets.get("STATE_DBX_PATH_VINCI")
...
with rc:
    st.markdown(
        "<h1 class='app-title' style='margin:0'>Vinci Career Fair</h1>"
